...
const GSUP_LEVEL_INTRO = {
  all:   "從最基礎的句子骨架，到貼近母語的表達方式，都在這裡——不知道從哪裡開始，可以先點🌱護土嫩芽。",
  a1a2:  "先把句子的骨架種起來——從基本動詞、核心句型開始扎根，之後才有辦法表達更複雜的想法。",
  b1:    "收集常用的句型跟語法工具，讓你從「會翻譯」再往前一步，學會表達願望、想法跟假設。",
  b2c1:  "釐清容易搞混的西語用法，不再被中文的直覺帶偏。",
  c1:    "貼近母語者真正在用的正式文法跟詞彙，挑戰更高難度的表達方式。"
};
