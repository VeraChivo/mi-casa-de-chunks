...
const GSUP_LEVEL_INTRO = {
  all:   "從最基礎的句子骨架，到接近母語的表達方式，全部都在這裡——不確定從哪裡開始，可以先點🌱護土嫩芽。",
  a1a2:  "先把句子的骨架種起來，從基本動詞、核心句型開始，建立之後表達更複雜想法需要的基礎。",
  b1:    "收集高頻使用的句型與語法工具，幫你從「會翻譯」進一步到「會表達願望、想法與假設」。",
  b2c1:  "釐清容易混淆的西語選擇，避免中文直覺造成誤用。",
  c1:    "更接近母語者實際使用的正式文法與詞彙，挑戰難度較高的表達方式。"
};
