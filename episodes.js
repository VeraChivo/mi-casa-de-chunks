...
{title:"Me Llamo Nita",titleZh:"認識自己",dur:150,sentences:[
  ...
  expand:{note:"Soy ___. = 換名字",template:[{t:"Soy"},{g:"name"},{t:"."}],groups:[{label:"名字",key:"name",options:[{es:"Tito",zh:"迪多"},{es:"Mimi",zh:"咪咪"},{es:"Kito",zh:"奇托"}]}]}},
  {es:"Soy una gatita.",chunks:[{w:"Soy",role:"v"},{w:"una gatita.",role:"o"}],zh:"我是一隻小貓咪。",en:"I am a little cat.",noteZh:"una gatita = 貓咪的可愛說法（字尾加-ita）",noteEn:"'una gatita' = a cute way to say 'a cat' (adding -ita)",
  expand:{note:"Soy ___. = 換動物的可愛說法",template:[{t:"Soy"},{g:"animal"},{t:"."}],groups:[{label:"什麼動物",key:"animal",options:[{es:"una gatita.",zh:"一隻小貓咪"},{es:"una ovejita.",zh:"一隻小綿羊"},{es:"una conejita.",zh:"一隻小兔子"}]}]}},
  {es:"Mi nombre es Nita.",chunks:[{w:"Mi nombre",role:"s"},{w:"es",role:"v"},{w:"Nita.",role:"o"}],zh:"我的名字是妮妲。",en:"My name is Nita.",noteZh:"mi nombre es = 我的名字是（比me llamo更正式的說法）",noteEn:"'mi nombre es' = a more formal way to say 'me llamo'",
  expand:{note:"Mi nombre es ___. = 換名字",template:[{t:"Mi nombre es"},{g:"name"},{t:"."}],groups:[{label:"名字",key:"name",options:[{es:"Tito",zh:"迪多"},{es:"Mimi",zh:"咪咪"},{es:"Kito",zh:"奇托"}]}]}},
  {es:"Me dicen Nita.",chunks:[{w:"Me dicen",role:"v"},{w:"Nita.",role:"o"}],zh:"大家都叫我妮妲。",en:"They call me Nita.",noteZh:"me dicen = 大家都叫我…（別人怎麼稱呼我）",noteEn:"'me dicen' = people call me... (how others refer to you)",
  expand:{note:"Me dicen ___. = 換大家怎麼叫我",template:[{t:"Me dicen"},{g:"name"},{t:"."}],groups:[{label:"名字",key:"name",options:[{es:"Tito",zh:"迪多"},{es:"Mimi",zh:"咪咪"},{es:"Vera",zh:"薇拉"}]}]}},
  {es:"¡Hola! Me llamo Nita.",chunks:[{w:"¡Hola!"},{w:"Me llamo",role:"v"},{w:"Nita.",role:"o"}],zh:"嗨！我叫妮妲。",en:"Hi! My name is Nita.",noteZh:"¡Hola! = 見面打招呼的第一句話",noteEn:"'¡Hola!' = the first word you say when greeting someone",
  expand:{note:"¡Hola! Me llamo ___. = 換名字",template:[{t:"¡Hola! Me llamo"},{g:"name"},{t:"."}],groups:[{label:"名字",key:"name",options:[{es:"Kito",zh:"奇托"},{es:"Tito",zh:"迪多"},{es:"Mimi",zh:"咪咪"}]}]}},
  {es:"Soy una gata pequeña.",chunks:[{w:"Soy",role:"v"},{w:"una gata pequeña.",role:"o"}],zh:"我是一隻小小的貓。",en:"I am a little cat.",noteZh:"pequeña放在gata後面：形容詞放名詞後面，跟英文相反",noteEn:"'pequeña' comes after 'gata': adjectives go after nouns in Spanish, opposite of English",
  expand:{note:"Soy una gata ___. = 換形容詞",template:[{t:"Soy una gata"},{g:"adj"},{t:"."}],groups:[{label:"怎麼樣",key:"adj",options:[{es:"pequeña.",zh:"小小的"},{es:"curiosa.",zh:"好奇的"},{es:"tranquila.",zh:"安靜的"}]}]}},
  {es:"Mi nombre es Nita y soy una gatita.",chunks:[{w:"Mi nombre",role:"s"},{w:"es",role:"v"},{w:"Nita",role:"o"},{w:"y",role:"c"},{w:"soy",role:"v"},{w:"una gatita.",role:"o"}],zh:"我的名字是妮妲，我是一隻小貓咪。",en:"My name is Nita, and I am a little cat.",noteZh:"y = 和／而且，把兩句話接成一句",noteEn:"'y' = and, joining two ideas into one sentence",
  expand:{note:"Mi nombre es Nita y soy una gatita ___. = 換形容詞",template:[{t:"Mi nombre es Nita y soy una gatita"},{g:"adj"},{t:"."}],groups:[{label:"怎麼樣",key:"adj",options:[{es:"pequeña.",zh:"小小的"},{es:"curiosa.",zh:"好奇的"},{es:"feliz.",zh:"開心的"}]}]}},
  ...
  expand:{note:"Mucho gusto, soy ___. = 換名字",template:[{t:"Mucho gusto, soy"},{g:"name"},{t:"."}],groups:[{label:"名字",key:"name",options:[{es:"Tito",zh:"迪多"},{es:"Mimi",zh:"咪咪"},{es:"Kito",zh:"奇托"}]}]}},
  ...
  expand:{note:"Este es mi pequeño ___. = 換名詞",template:[{t:"Este es mi pequeño"},{g:"noun"},{t:"."}],groups:[{label:"什麼",key:"noun",options:[{es:"mundo.",zh:"世界"},{es:"rincón.",zh:"角落"},{es:"jardín.",zh:"花園"}]}]}}
]},
{title:"Mi Familia y Mis Amigos",titleZh:"我的家人與朋友",dur:150,sentences:[
  ...
  expand:{note:"Tengo una familia y ___. = 換第二個人",template:[{t:"Tengo una familia y"},{g:"who"},{t:"."}],groups:[{label:"還有誰",key:"who",options:[{es:"una amiga.",zh:"一個女性朋友"},{es:"un amigo.",zh:"一個男性朋友"},{es:"una hermana.",zh:"一個姐妹"}]}]}},
  ...
  expand:{note:"Yo soy Papá Tato, el papá de ___. = 換是誰的爸爸",template:[{t:"Yo soy Papá Tato, el papá de"},{g:"name"},{t:"."}],groups:[{label:"誰的爸爸",key:"name",options:[{es:"Nita",zh:"妮妲"},{es:"Tito",zh:"迪多"},{es:"Mimi",zh:"咪咪"}]}]}},
  ...
  expand:{note:"Yo soy ___. = 換名字",template:[{t:"Yo soy"},{g:"name"},{t:"."}],groups:[{label:"名字",key:"name",options:[{es:"Tito",zh:"迪多"},{es:"Mimi",zh:"咪咪"},{es:"Vera",zh:"薇拉"}]}]}},
  ...
  expand:{note:"Soy el hermano ___ de Nita. = 換年紀大小",template:[{t:"Soy el hermano"},{g:"age"},{t:"de Nita."}],groups:[{label:"哥哥或弟弟",key:"age",options:[{es:"mayor.",zh:"哥哥（較年長）"},{es:"menor.",zh:"弟弟（較年幼）"}]}]}},
  ...
  expand:{note:"Yo soy ___, el hermano de Nita. = 換名字",template:[{t:"Yo soy"},{g:"name"},{t:", el hermano de Nita."}],groups:[{label:"名字",key:"name",options:[{es:"Tito",zh:"迪多"},{es:"Kito",zh:"奇托"}]}]}},
  ...
  expand:{note:"Yo soy Mimi, la hermanita ___ de Nita. = 換形容詞",template:[{t:"Yo soy Mimi, la hermanita"},{g:"desc"},{t:"de Nita."}],groups:[{label:"怎麼形容",key:"desc",options:[{es:"bebé",zh:"小寶寶"},{es:"pequeña",zh:"年紀最小的"},{es:"menor",zh:"較年幼的"}]}]}},
  ...
  expand:{note:"Yo soy ___. = 換名字",template:[{t:"Yo soy"},{g:"name"},{t:"."}],groups:[{label:"名字",key:"name",options:[{es:"Vera",zh:"薇拉"},{es:"Kito",zh:"奇托"},{es:"Tito",zh:"迪多"}]}]}},
  ...
  expand:{note:"Soy ___ de Nita. = 換身分",template:[{t:"Soy"},{g:"role"},{t:"de Nita."}],groups:[{label:"什麼身分",key:"role",options:[{es:"la mejor amiga",zh:"最好的朋友（女）"},{es:"el mejor amigo",zh:"最好的朋友（男）"},{es:"la vecina",zh:"鄰居（女）"}]}]}},
  ...
  expand:{note:"Somos la familia y los amigos de ___. = 換是誰的家人朋友",template:[{t:"Somos la familia y los amigos de"},{g:"name"},{t:"."}],groups:[{label:"誰的家人朋友",key:"name",options:[{es:"Nita",zh:"妮妲"},{es:"Tito",zh:"迪多"},{es:"Mimi",zh:"咪咪"}]}]}}
]},
{title:"Mi Día a Día",titleZh:"我的日常／我的狀態",dur:150,sentences:[
  ...
  expand:{note:"Mamá Cata está ocupada en ___. = 換地點",template:[{t:"Mamá Cata está ocupada en"},{g:"place"},{t:"."}],groups:[{label:"哪裡",key:"place",options:[{es:"la cocina.",zh:"廚房"},{es:"el jardín.",zh:"花園"},{es:"la sala.",zh:"客廳"}]}]}},
  {es:"Papá Tato está trabajando en el jardín.",chunks:[{w:"Papá Tato",role:"s"},{w:"está trabajando",role:"v"},{w:"en el jardín.",role:"o"}],zh:"達多爸爸在花園裡工作。",en:"Papá Tato is working in the garden.",noteZh:"está trabajando = 正在工作（ESTAR+動詞-ando/-iendo，表示正在做的事）",noteEn:"'está trabajando' = is working (ESTAR + -ando/-iendo shows something happening right now)",
  expand:{note:"___ está trabajando en el jardín. = 換是誰",template:[{g:"who"},{t:"está trabajando en el jardín."}],groups:[{label:"誰",key:"who",options:[{es:"Papá Tato",zh:"達多爸爸"},{es:"Mamá Cata",zh:"卡妲媽媽"},{es:"Vera",zh:"薇拉"}]}]}},
  {es:"Tito está esperando su turno para jugar.",chunks:[{w:"Tito",role:"s"},{w:"está esperando",role:"v"},{w:"su turno para jugar.",role:"o"}],zh:"迪多在等輪到他玩。",en:"Tito is waiting for his turn to play.",noteZh:"esperar su turno = 等輪到自己",noteEn:"'esperar su turno' = waiting for one's turn",
  expand:{note:"___ está esperando su turno para jugar. = 換是誰",template:[{g:"who"},{t:"está esperando su turno para jugar."}],groups:[{label:"誰",key:"who",options:[{es:"Tito",zh:"迪多"},{es:"Mimi",zh:"咪咪"},{es:"Nita",zh:"妮妲"}]}]}},
  {es:"Vera está en la puerta, lista para entrar.",chunks:[{w:"Vera",role:"s"},{w:"está",role:"v"},{w:"en la puerta,",role:"o"},{w:"lista para entrar.",role:"o"}],zh:"薇拉在門口，準備要進來。",en:"Vera is at the door, ready to come in.",noteZh:"está en la puerta = 人在門口（ESTAR+地點，說某人在哪裡）",noteEn:"'está en la puerta' = is at the door (ESTAR+location, saying where someone is)",
  expand:{note:"___ está en la puerta, lista para entrar. = 換是誰",template:[{g:"who"},{t:"está en la puerta, lista para entrar."}],groups:[{label:"誰",key:"who",options:[{es:"Vera",zh:"薇拉"},{es:"Kito",zh:"奇托"},{es:"Mimi",zh:"咪咪"}]}]}},
  {es:"Mimi tiene hambre y llora un poco.",chunks:[{w:"Mimi",role:"s"},{w:"tiene hambre",role:"v"},{w:"y",role:"c"},{w:"llora un poco.",role:"v"}],zh:"咪咪肚子餓了，哭了一下下。",en:"Mimi is hungry and cries a little.",noteZh:"tener hambre = 肚子餓（跟tener sueño同一種TENER+感覺用法）",noteEn:"'tener hambre' = to be hungry (same TENER+feeling pattern as 'tener sueño')",
  expand:{note:"___ tiene hambre y llora un poco. = 換是誰",template:[{g:"who"},{t:"tiene hambre y llora un poco."}],groups:[{label:"誰",key:"who",options:[{es:"Mimi",zh:"咪咪"},{es:"Tito",zh:"迪多"},{es:"Nita",zh:"妮妲"}]}]}},
  {es:"Nita está tranquila en su rincón favorito.",chunks:[{w:"Nita",role:"s"},{w:"está",role:"v"},{w:"tranquila",role:"o"},{w:"en su rincón favorito.",role:"o"}],zh:"妮妲在她最愛的角落裡，很安靜。",en:"Nita is calm in her favorite corner.",noteZh:"está tranquila = 現在很平靜（形容當下的心情，不是說她一直都這樣）",noteEn:"'está tranquila' = is calm right now (describes the current mood, not a permanent trait)",
  expand:{note:"Nita está ___ en su rincón favorito. = 換心情",template:[{t:"Nita está"},{g:"mood"},{t:"en su rincón favorito."}],groups:[{label:"什麼心情",key:"mood",options:[{es:"tranquila",zh:"平靜"},{es:"feliz",zh:"開心"},{es:"cansada",zh:"疲累"}]}]}},
  {es:"Toda la familia está en casa hoy.",chunks:[{w:"Toda la familia",role:"s"},{w:"está",role:"v"},{w:"en casa hoy.",role:"o"}],zh:"今天全家人都在家。",en:"The whole family is home today.",noteZh:"toda la familia = 全家人（toda強調每一個人都在內）",noteEn:"'toda la familia' = the whole family (toda emphasizes everyone included)",
  expand:{note:"Toda la familia está en casa ___. = 換時間",template:[{t:"Toda la familia está en casa"},{g:"when"},{t:"."}],groups:[{label:"什麼時候",key:"when",options:[{es:"hoy.",zh:"今天"},{es:"ahora.",zh:"現在"},{es:"esta tarde.",zh:"今天下午"}]}]}},
  ...
  expand:{note:"Nita tiene ganas de jugar con ___. = 換跟誰玩",template:[{t:"Nita tiene ganas de jugar con"},{g:"who"},{t:"."}],groups:[{label:"跟誰",key:"who",options:[{es:"Tito.",zh:"迪多"},{es:"Mimi.",zh:"咪咪"},{es:"Vera.",zh:"薇拉"}]}]}},
  {es:"Es un día tranquilo en la Casa Gato.",chunks:[{w:"Es",role:"v"},{w:"un día tranquilo",role:"o"},{w:"en la Casa Gato.",role:"o"}],zh:"這是貓咪家平靜的一天。",en:"It's a calm day at the Cat House.",noteZh:"Es un día tranquilo = 這是平靜的一天（用SER幫一整天下總結）",noteEn:"'Es un día tranquilo' = it's a calm day (using SER to sum up the whole day)",
  expand:{note:"Es un día ___ en la Casa Gato. = 換形容詞",template:[{t:"Es un día"},{g:"adj"},{t:"en la Casa Gato."}],groups:[{label:"怎麼樣的一天",key:"adj",options:[{es:"tranquilo",zh:"平靜的"},{es:"feliz",zh:"開心的"},{es:"especial",zh:"特別的"}]}]}}
]},
{title:"Lo Que Nos Gusta",titleZh:"我的喜歡",dur:150,sentences:[
  ...
  expand:{note:"A Tito le encanta su carrito ___. = 換顏色",template:[{t:"A Tito le encanta su carrito"},{g:"color"},{t:"."}],groups:[{label:"什麼顏色",key:"color",options:[{es:"rojo.",zh:"紅色"},{es:"azul.",zh:"藍色"},{es:"verde.",zh:"綠色"}]}]}},
  ...
  expand:{note:"A ___ le encanta cocinar para su familia. = 換是誰",template:[{t:"A"},{g:"who"},{t:"le encanta cocinar para su familia."}],groups:[{label:"誰",key:"who",options:[{es:"Papá Tato",zh:"達多爸爸"},{es:"Mamá Cata",zh:"卡妲媽媽"},{es:"Vera",zh:"薇拉"}]}]}},
  ...
  expand:{note:"A Mamá Cata le gusta tomar café ___. = 換時間",template:[{t:"A Mamá Cata le gusta tomar café"},{g:"when"},{t:"."}],groups:[{label:"什麼時候",key:"when",options:[{es:"por la mañana.",zh:"早上"},{es:"por la tarde.",zh:"下午"},{es:"por la noche.",zh:"晚上"}]}]}},
  {es:"A Vera le gusta escuchar a sus amigos.",chunks:[{w:"A Vera le",role:"s"},{w:"gusta",role:"v"},{w:"escuchar a sus amigos.",role:"o"}],zh:"薇拉喜歡聽朋友說話。",en:"Vera likes listening to her friends.",noteZh:"escuchar a sus amigos = 聽朋友說話（escuchar後面接人要加a）",noteEn:"'escuchar a sus amigos' = listening to her friends ('a' is added before a person after escuchar)",
  expand:{note:"A ___ le gusta escuchar a sus amigos. = 換是誰",template:[{t:"A"},{g:"who"},{t:"le gusta escuchar a sus amigos."}],groups:[{label:"誰",key:"who",options:[{es:"Vera",zh:"薇拉"},{es:"Nita",zh:"妮妲"},{es:"Kito",zh:"奇托"}]}]}},
  ...
  expand:{note:"A Mimi le encantan ___. = 換喜歡的東西（複數）",template:[{t:"A Mimi le encantan"},{g:"food"},{t:"."}],groups:[{label:"喜歡什麼（複數）",key:"food",options:[{es:"las galletas.",zh:"餅乾"},{es:"las frutas.",zh:"水果"},{es:"los dulces.",zh:"糖果"}]}]}},
  {es:"A Nita también le gusta dibujar.",chunks:[{w:"A Nita también le",role:"s"},{w:"gusta",role:"v"},{w:"dibujar.",role:"o"}],zh:"妮妲也喜歡畫畫。",en:"Nita also likes drawing.",noteZh:"también = 也（接續前面，說她還喜歡別的事）",noteEn:"'también' = also (adding one more thing this person likes)",
  expand:{note:"A Nita también le gusta ___. = 換喜歡做的事",template:[{t:"A Nita también le gusta"},{g:"activity"},{t:"."}],groups:[{label:"喜歡做什麼",key:"activity",options:[{es:"dibujar.",zh:"畫畫"},{es:"cantar.",zh:"唱歌"},{es:"bailar.",zh:"跳舞"}]}]}},
  ...
  expand:{note:"A Tito no le gusta ___. = 換不喜歡的東西",template:[{t:"A Tito no le gusta"},{g:"thing"},{t:"."}],groups:[{label:"不喜歡什麼",key:"thing",options:[{es:"el ruido fuerte.",zh:"很大的聲音"},{es:"la lluvia.",zh:"下雨"},{es:"esperar.",zh:"等待"}]}]}},
  ...
  expand:{note:"A toda la familia le gusta ___. = 換喜歡做的事",template:[{t:"A toda la familia le gusta"},{g:"activity"},{t:"."}],groups:[{label:"喜歡做什麼",key:"activity",options:[{es:"estar junta.",zh:"待在一起"},{es:"cocinar juntos.",zh:"一起煮飯"},{es:"jugar juntos.",zh:"一起玩"}]}]}},
  ...
  expand:{note:"Y a Nita le gusta mucho ___. = 換喜歡的東西",template:[{t:"Y a Nita le gusta mucho"},{g:"thing"},{t:"."}],groups:[{label:"喜歡什麼",key:"thing",options:[{es:"su pequeña casa.",zh:"她的小房子"},{es:"su pequeño mundo.",zh:"她的小世界"},{es:"estar en casa.",zh:"待在家裡"}]}]}}
]}
];
...
// ── Episode完成畫面的「終點角色」宣告表（2026-07-24，取代原本ep===EPS.length-1的隱性判斷）──
// 由集數自己宣告角色，不是由陣列末端位置推論——之後加新集數/新路線，只需要在這裡加index，
// 不用動showComplete()的判斷邏輯。
// storyFinale：故事線真正終章，完成時顯示終章彩蛋(completeFinaleEgg)。
//   目前刻意留空——原本掛在ep===EPS.length-1上的彩蛋台詞「Y será el último en volver a
//   su lugar.」查證Git歷史後，發現從2026-07-14加入時就只是跟著陣列尾端滑動(當時對到E7)，
//   2026-07-17 SEL併入EPS變成E12-E16後才意外「看起來」對到E16，從未有人明確設計/驗證過
//   它該對應哪一集。E15/E16在語意上都只是推測，不是查證得到的事實，所以不填值、彩蛋
//   暫不顯示，等未來真的確認要用在哪裡再補。
...
const CHUNK_ECOLOGY = {
  reusableChunk: [112,113,119, 130,131,132,133,134,135,136,137,138, 154,156,158,
    // E18-E20（2026-08-12盤查，判準同上：拿掉集數上下文，換場景還會不會有人這樣講）
    170,171,174,179, 180,182,183,188, 190,192,195,197],
  episodeOnly: [102,103,104,106, 110,114,115,116,117,118, 120, 141,143,144,145,146,147,148, 150,153,
    // E18-E20：與已選reusableChunk同一種「Yo soy X, 關係詞 de Nita」句型重複、場景過細、或收尾句
    172,173,175,176,177,178, 181,184,185,186,187,189, 191,193,194,196,198,199],
