...
{title:"Me Llamo Nita",titleZh:"認識自己",dur:150,sentences:[
  ...
  {es:"¡Hola! Me llamo Nita.",chunks:[{w:"¡Hola!"},{w:"Me llamo",role:"v"},{w:"Nita.",role:"o"}],zh:"嗨！我叫妮妲。",en:"Hi! My name is Nita."},
  ...
  {es:"Mi nombre es Nita y soy una gatita.",chunks:[{w:"Mi nombre",role:"s"},{w:"es",role:"v"},{w:"Nita",role:"o"},{w:"y",role:"c"},{w:"soy",role:"v"},{w:"una gatita.",role:"o"}],zh:"我的名字是妮妲，我是一隻小貓咪。",en:"My name is Nita, and I am a little cat."},
