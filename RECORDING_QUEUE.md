...
| 🌻 劇情逐字語塊（`CHUNK_AUDIO_MAP`） | 735 次／520 個 | 500 次 | 🟡 235 次（32%） |
...
## 🟡 缺口③：劇情逐字語塊 32%（第一批已錄完，其餘維持現況不一次補齊）

> ✅ **2026-08-20 第一批 25 個高頻語塊已錄完接上**：出現 2 次以上的語塊全部有真人音檔了
> （gusta 7次／Nita. 6次／Yo soy 6次／Soy 5次／Somos·vive·Cansancio. 各3次，以及 A Nita le、
> Me llamo、Mi nombre、una gatita.、Cata、El Yo Pequeñito、A veces、cuando、también、
> sin embargo,、Y 和 SEL 線七個情緒角色呼名）。
> 缺口從 304 次／41% 降到 235 次／32%，全站被引用的音檔路徑 1959 → 1984 個，100% 存在。
> 剩下的 235 個都只出現 1 次，依既有定案維持 TTS、之後再分批。
