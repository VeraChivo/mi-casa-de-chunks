...
const WELCOME_TOUR_STEPS = [
  {icon:"🏡", title:"歡迎來到你的西語小莊園", desc:"這是一座屬於你的西語故事小莊園。<br><br>每一段故事，都會留下幾顆可以帶走的語塊；你可以在田地裡播種，在花園裡慢慢長大，也能把學會的西語帶回自己的生活裡。<br><br>這座莊園沒有固定的進度。你可以跟著故事走，也可以今天只摘一顆自己喜歡的語塊。"},
  {icon:"🌾", title:"田間播語塊", desc:"這裡是每日播種語塊的園地。點開劇情短句，跟著真人音檔聽、跟讀，一詞一句拆解西語；可以查看句子裡的文法與語塊，練習換詞造句。完成句子還能解鎖彈藥庫語塊，也可以把學會的句子帶去自己的日記裡使用。"},
  {icon:"☀️", title:"日光育苗場", desc:"這裡放著莊園裡可以慢慢探索的知識。可以查文法、看動詞變位，認識 SEL 情緒篇章、文化故事與假同源詞避雷，也能沿著相關卡片繼續往下挖。想知道「為什麼這樣說」，就來這裡找答案。"},
  {icon:"🛌", title:"床邊低語呢", desc:"深夜的燈還亮著。這裡可以寫西語日記、留下真心話句，也可以把平常學到的語塊拿來自由使用。想寫什麼就寫什麼，不用照課本，也不用趕進度。"},
  {icon:"🗃️", title:"穀倉大豐收", desc:"這裡收著妳一路累積下來的東西。可以查看語塊花園的熟練度、翻自己的詞彙本，也能管理資料備份保險箱；學過什麼、收下多少、一路走了多遠，都可以在這裡找到。"},
